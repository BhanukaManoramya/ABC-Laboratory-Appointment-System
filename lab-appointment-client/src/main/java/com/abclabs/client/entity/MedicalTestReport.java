...
public class MedicalTestReport {
	...
	public String toString() {
		return "MedicalTestReport [id=" + id + ", testType=" + testType + ", reason=" + reason + ", laboratory="
				+ laboratory + ", dateTime=" + dateTime + ", labTechnician=" + labTechnician + ", doctor=" + doctor
				+ ", overallResult=" + overallResult + ", labReport=" + labReport + "]";
	}
